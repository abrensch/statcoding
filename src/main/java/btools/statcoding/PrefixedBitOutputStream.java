...
/**
 * A PrefixedBitOutputStream is usually used to encode a
 * data structure that is expected to evolve.It prefixes
 * the actual data section by a header containing
 * version information (major/minor) and the size
 * of the data section in bytes.
 * 
 * A minor version change is expected to keep
 * old decoders working by just skipping any
 * unknown, additional data. This is achieved by
 * prefixing the size.
 */
public class PrefixedBitOutputStream extends BitOutputStream {
    ...
    /**
     * Construct a PrefixedBitOutputStream.
     * <br>
